...
class PRPR:
    ...
    defaultMethodDescriptions = {
        ...
        'ru' : {
            'LC_W_Bot_Bot' : {
                'short': 'со дна на дно',
                'long': 'Забрать материал со дна исходной лунки, внести его на дно в лунке назначения'
            },
            'LC_W_Bot_Air' : {
                'short': 'со дна над уровнем',
                'long': 'Забрать материал со дна исходной лунки, внести его над уровнем реагента в лунке назначения'
            },
            'LC_W_Bot_Lev' : {
                'short': 'со дна на уровень',
                'long': 'Забрать материал со дна исходной лунки, внести его на уровне реагента в лунке назначения'
            },
            'LC_W_Lev_Bot' : {
                'short': 'с уровня на дно',
                'long': 'Забрать материал с уровня реагента в исходной лунке, внести его на дно в лунке назначения'
            },
            'LC_W_Lev_Air' : {
                'short': 'с уровня над уровнем',
                'long': 'Забрать материал с уровня реагента в исходной лунке, внести его над уровнем реагента в лунке назначения'
            },
            'LC_W_Lev_Lev' : {
                'short': 'с уровня на уровень',
                'long': 'Забрать материал с уровня реагента в исходной лунке, внести его на уровне реагента в лунке назначения'
            }
        }
    }
